...
//@line 41 "e:\builds\moz2_slave\mozilla-1.9.2-win32-xulrunner\build\xulrunner\setup\nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 235 "e:\builds\moz2_slave\mozilla-1.9.2-win32-xulrunner\build\xulrunner\setup\nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "e:\builds\moz2_slave\mozilla-1.9.2-win32-xulrunner\build\xulrunner\setup\nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 265 "e:\builds\moz2_slave\mozilla-1.9.2-win32-xulrunner\build\xulrunner\setup\nsXULAppInstall.js"
      aLeafName = appName;
//@line 270 "e:\builds\moz2_slave\mozilla-1.9.2-win32-xulrunner\build\xulrunner\setup\nsXULAppInstall.js"
    }
...
//@line 341 "e:\builds\moz2_slave\mozilla-1.9.2-win32-xulrunner\build\xulrunner\setup\nsXULAppInstall.js"
...
//@line 348 "e:\builds\moz2_slave\mozilla-1.9.2-win32-xulrunner\build\xulrunner\setup\nsXULAppInstall.js"
  }
};
