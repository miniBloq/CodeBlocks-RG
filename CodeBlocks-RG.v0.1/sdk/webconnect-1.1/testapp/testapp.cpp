...
public:
    ...
    bool OnInit()
    {
        ...
        //##2011.01.09:Descablear:
        //wxString xulrunner_path = FindXulRunner(wxT("xr"));
        wxString xulrunner_path = wxString("C:/Projects/Multiplo/Soft/CodeBlocks-RG/v1.0/Soft/sdk/webconnect-1.1/xr");
...
//##2011.01.09: Temporal, lo saqué para ver si linkea:
...
//##2011.01.09: End
    ...
    //##2011.01.09:
    wxMessageBox(wxT("Before OpenURI")); //##Debug.
    ...
    //##2011.01.09:
    wxMessageBox(wxT("After OpenURI")); //##Debug.
}
